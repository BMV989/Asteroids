...
class Starship(MoveableObject):
    ...
    def calc_cords(self):
        ...
        c3 = (int((self.x - self.side * 0.8 * sin(self.angle / 2))), int((self.y + self.side * 0.8 * cos(self.angle / 2))))
        c4 = (int((self.x + self.side * 0.8 * sin(self.angle / 2))), int((self.y + self.side * 0.8 * cos(self.angle / 2))))
